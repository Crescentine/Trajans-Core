...
public class StatsOverlay {
    ...
    public void onRenderTick(TickEvent.RenderTickEvent event)
    {
        ...
        String speed = format1.format(tank.getSpeedPercent());
        ...
        mc.font.drawShadow(matrixStack, ChatFormatting.BOLD + "Speed: " + ChatFormatting.WHITE + speed + "%", 10, 30, Color.CYAN.getRGB());
    }
}
