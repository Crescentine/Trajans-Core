...
public class BaseTrackedVehicle extends Entity {

    public double healAmount = 0;
    public boolean armored;
    public double speedMultiplier = 0;

    private static final EntityDataAccessor<Integer> FUEL_AMOUNT = SynchedEntityData.defineId(BaseTrackedVehicle.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Float> SPEED = SynchedEntityData.defineId(BaseTrackedVehicle.class, EntityDataSerializers.FLOAT);
    public static final EntityDataAccessor<Integer> MAX_HEALTH = SynchedEntityData.defineId(BaseTrackedVehicle.class, EntityDataSerializers.INT);
    public static final EntityDataAccessor<Integer> HEALTH = SynchedEntityData.defineId(BaseTrackedVehicle.class, EntityDataSerializers.INT);
    ...
    public BaseTrackedVehicle(EntityType<? extends BaseTrackedVehicle> entityType, Level world) {
