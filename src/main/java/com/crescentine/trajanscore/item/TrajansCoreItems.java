...
public class TrajansCoreItems {
    ...
    public static final RegistryObject<Item> PLATE_PRESS_BLOCK_ITEM = ITEMS.register("plate_press_block_item",
            () -> new PlatingPressItem(TrajansCoreItems.PLATE_PRESS_BLOCK.get(), new Item.Properties()));
    public static final RegistryObject<Item> TURRET_FACTORY_BLOCK_ITEM = ITEMS.register("turret_factory_block_item",
            () -> new TurretFactoryItem(TrajansCoreItems.TURRET_FACTORY.get(), new Item.Properties()));
    public static final RegistryObject<Item> ENGINE_FABRICATOR_ITEM = ITEMS.register("engine_fabricator_item",
            () -> new EngineFabricatorItem(TrajansCoreItems.ENGINE_FABRICATOR.get(), new Item.Properties()));
    public static final RegistryObject<Item> STEEL_MANUFACTURER_ITEM = ITEMS.register("steel_manufacturer_item",
            () -> new SteelManufacturerItem(TrajansCoreItems.STEEL_MANUFACTURER.get(), new Item.Properties()));
    ...
    public static final RegistryObject<Item> LIGHT_TANK_TURRET = ITEMS.register("light_tank_turret", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> LIGHT_ENGINE = ITEMS.register("light_engine", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> LIGHT_TANK_PLATING = ITEMS.register("light_tank_plating", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> LIGHT_TANK_TRACKS = ITEMS.register("light_tank_tracks", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> TANK_CONTROLLER = ITEMS.register("steering_crafting_item", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> HEAVY_TANK_TURRET = ITEMS.register("heavy_tank_turret", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> HEAVY_ENGINE = ITEMS.register("heavy_engine", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> HEAVY_TANK_PLATING = ITEMS.register("heavy_tank_plating", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> HEAVY_TANK_TRACKS = ITEMS.register("heavy_tank_tracks", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> MEDIUM_TANK_TURRET = ITEMS.register("medium_tank_turret", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> MEDIUM_ENGINE = ITEMS.register("medium_engine", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> MEDIUM_TANK_PLATING = ITEMS.register("medium_tank_plating", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> MEDIUM_TANK_TRACMS = ITEMS.register("medium_tank_tracks", () -> new Item(new Item.Properties()));
